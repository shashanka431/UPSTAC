...
public class LabRequestController {
    ...
    /*
     * Method to get the list of test requests having status as 'INITIATED'
     *
     */
    ...
    /*
     * Method to get the list of test requests assigned to the current tester
     *
     */
    @GetMapping
    @PreAuthorize("hasAnyRole('TESTER')")
    ...
    /*
     * Method to assign a particular test request to the current tester
     *
     */
    @PreAuthorize("hasAnyRole('TESTER')")
    ...
    /*
     * Method to update the result of the current test request id with tester comments
     *
     */
    @PreAuthorize("hasAnyRole('TESTER')")
